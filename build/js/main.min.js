...
document.addEventListener("DOMContentLoaded",()=>{new Swiper(".hero-slider",{slidesPerView:1,pagination:{el:".hero .swiper-pagination"},navigation:{nextEl:".hero .swiper-button-next",prevEl:".hero .swiper-button-prev"}}),new Swiper(".stock-slider",{loop:!0,spaceBetween:16,slidesPerView:"auto",navigation:{nextEl:".stock .swiper-button-next",prevEl:".stock .swiper-button-prev"},breakpoints:{640:{spaceBetween:53}}}),new Swiper(".spec-slider",{spaceBetween:16,slidesPerView:"auto",navigation:{nextEl:".benefits .swiper-button-next",prevEl:".benefits .swiper-button-prev"},breakpoints:{640:{spaceBetween:53,slidesPerView:4}}}),new Swiper(".reviews-slider",{loop:!0,slidesPerView:1,pagination:{el:".reviews .swiper-pagination",type:"fraction"},navigation:{nextEl:".reviews .swiper-button-next",prevEl:".reviews .swiper-button-prev"}});!function(){const e=document.querySelector(".header");!function(){let t=window.pageXOffset;console.log(t),t>0?e.classList.add("header-fixed"):e.classList.remove("header-fixed")}()}(),function(){const e=document.querySelector(".js-menu-mobile-button"),t=document.querySelector(".js-menu-mobile");let s=!1;e.addEventListener("touchstart",e=>{s?(t.classList.remove("is-open"),s=!1):(t.classList.add("is-open"),s=!0)})}(),function(){const e=document.querySelector(".header-menu__item--inner");e.addEventListener("mouseenter",e=>{e.target.querySelector(".inner-menu").classList.add("is-show")}),e.addEventListener("mouseleave",e=>{e.target.querySelector(".inner-menu").classList.remove("is-show")})}(),function(){const e=document.querySelectorAll(".js-service-tab-item"),t=document.querySelectorAll(".js-service-tab-content");e.forEach(s=>{s.addEventListener("click",()=>{e.forEach(e=>{e.classList.remove("is-active")}),s.classList.add("is-active");const n=s.id;t.forEach(e=>{e.classList.remove("is-active")});document.getElementsByClassName(""+n)[0].classList.add("is-active")})})}()});
