...
document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".header:not(.header--fixed)"),t=e.offsetHeight,n=document.querySelector(".main");function s(){const s=window.pageYOffset;s>0?(n.style.paddingTop=t+"px",e.classList.add("header--fixed")):0==s&&(n.style.paddingTop=0,e.classList.remove("header--fixed"))}s(),window.addEventListener("scroll",s,!1);new Swiper(".hero-slider",{slidesPerView:1,pagination:{el:".hero .swiper-pagination"},navigation:{nextEl:".hero .swiper-button-next",prevEl:".hero .swiper-button-prev"}}),new Swiper(".stock-slider",{loop:!0,spaceBetween:16,slidesPerView:"auto",navigation:{nextEl:".stock .swiper-button-next",prevEl:".stock .swiper-button-prev"},breakpoints:{640:{spaceBetween:53}}}),new Swiper(".spec-slider",{spaceBetween:16,slidesPerView:"auto",navigation:{nextEl:".benefits .swiper-button-next",prevEl:".benefits .swiper-button-prev"},breakpoints:{640:{spaceBetween:53,slidesPerView:4}}}),new Swiper(".reviews-slider",{loop:!0,slidesPerView:1,pagination:{el:".reviews .swiper-pagination",type:"fraction"},navigation:{nextEl:".reviews .swiper-button-next",prevEl:".reviews .swiper-button-prev"}});!function(){const e=document.querySelector(".js-menu-mobile-button"),t=document.querySelector(".js-menu-mobile"),n=document.querySelector(".icon-menu"),s=document.querySelector(".icon-cancel");let i=!1;e.addEventListener("touchend",e=>{i?(t.classList.remove("is-open"),n.style.display="block",s.style.display="none",i=!1):(t.classList.add("is-open"),n.style.display="none",s.style.display="block",i=!0)})}(),function(){const e=document.querySelectorAll(".header-menu__item--inner"),t=document.querySelectorAll(".inner-menu"),n=document.querySelector(".header-menu__wrap"),s=document.querySelector(".header-menu-back"),i=document.querySelector(".btn-menu-back");e.forEach(e=>{e.addEventListener("touchend",(function(e){e.stopPropagation();const t=e.currentTarget.querySelector(".inner-menu").offsetHeight;n.style.height=t+"px",s.style.display="block"}))}),i.addEventListener("touchend",(function(e){n.style.height="auto",t.forEach(e=>{e.classList.remove("is-show")}),s.style.display="none",e.stopPropagation()}),!1)}(),function(){const e=document.querySelector(".header-menu__item--inner");e.addEventListener("mouseenter",e=>{e.currentTarget.querySelector(".inner-menu").classList.add("is-show")}),e.addEventListener("touchend",e=>{if(e.currentTarget.classList.contains("header-menu__item--inner")){e.currentTarget.querySelector(".inner-menu").classList.add("is-show")}}),e.addEventListener("mouseleave",e=>{e.currentTarget.querySelector(".inner-menu").classList.remove("is-show")})}(),function(){const e=document.querySelectorAll(".js-service-tab-item"),t=document.querySelectorAll(".js-service-tab-content");e.forEach(n=>{n.addEventListener("click",()=>{e.forEach(e=>{e.classList.remove("is-active")}),n.classList.add("is-active");const s=n.id;t.forEach(e=>{e.classList.remove("is-active")});document.getElementsByClassName(""+s)[0].classList.add("is-active")})})}()});
